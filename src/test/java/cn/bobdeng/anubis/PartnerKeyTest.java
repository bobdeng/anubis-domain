...
public class PartnerKeyTest {
    ...
    @Test
    public void should_verify_success_when_has_not_expired_key() {
        partnerKeyDao.save(PartnerKeyDO.builder()
                .partnerId(partner.id())
    ...
    @Test
    public void should_verify_fail_when_has_wrong_key() {
        partnerKeyDao.save(PartnerKeyDO.builder()
                .partnerId(partner.id())
                .key("1")
                .build());
    ...
    @Test
    public void should_do_nothing_when_id_wrong() {
        PartnerKeyDO partnerKeyDO = partnerKeyDao.save(PartnerKeyDO.builder()
                .partnerId(partner.id())
                .key(key)
                .build());
        long expireAt = System.currentTimeMillis();
        partner.findKey(100).ifPresent(partnerKey -> {
            partnerKey.setExpireAt(expireAt);
        });

        partnerKeyDO = partnerKeyDao.all().get(0);
        assertThat(partnerKeyDO.getExpireAt(), nullValue());
    }
}
